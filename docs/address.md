# RaidenCash Address
Represents a RaidenCash address. Addresses are the most popular way to make RaidenCash transactions. See [the RaidenCash documentation](https://dash-docs.github.io/en/glossary/address) for technical background information.
